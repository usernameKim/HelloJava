		...
		<section class="section-margin calc-60px">
			<div class="container">
				...
				<div class="row">
					...
					<c:forEach var="item" items="${items}" begin="1" end="8" step="1">
					
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="card text-center card-product">
								<div class="card-product__img">
									<img class="card-img" src="img/product/${item[i].itemImage} " alt="">
								...
								<div class="card-body">
									...
									<h4 class="card-product__title">
										<a href="single-product.html">${item[i].itemImage}</a>
									</h4>
									<p class="card-product__price">$${item[i].itemImage}</p>
								</div>
							</div>
						</div>
					</c:forEach>
